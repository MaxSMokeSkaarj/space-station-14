...
admin-solutions-window-volume-label = Объем {$currentVolume}/{$maxVolume}u
admin-solutions-window-capacity-label = Вместимость (u):
admin-solutions-window-specific-heat-label = Удельная теплоемкость: {$specificHeat} Дж/(К*u)
