...
ent-XenoborgCameraMonitorCircuitboard = монитор беспроводных камер ксеноборгов (консольная плата)
    .desc = Консольная плата для монитора беспроводных камер ксеноборгов.
