...
cmd-set-map-atmos-help = setmapatmos <mapid> <пространство> [<температура> [моли...]]
...
cmd-set-map-atmos-hint-space = <пространство>
cmd-set-map-atmos-hint-temp = <температура> (число с плавающей точкой)
