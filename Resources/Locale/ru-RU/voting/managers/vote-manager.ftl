...
ui-vote-restart-abstain = Воздержусь
...
ui-vote-votekick-title = { $initiator } начал голосование за кик игрока: { $targetEntity }. Причина: { $reason }
